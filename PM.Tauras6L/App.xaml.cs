...
namespace PM.Tauras6L
{
    ...
    public partial class App : System.Windows.Application, ISingleInstance
    {
        ...
        public TaskHistoryViewModel TaskHistoryViewModel { get; set; }
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            try
            {
                bool isFirstInstance = this.InitializeAsFirstInstance("PM.Tauras6L");
                if (!isFirstInstance)
                {
                    Current.Shutdown();
                }
                ...
                TaskHistoryViewModel = new TaskHistoryViewModel(ReportTaskService);
