...
{
    public class HandleAggregationAddPalletViewModel : ViewModel
    {
        ...
        public HandleAggregationAddPalletViewModel(ProcessingCodeService processingCodeService,
            ...
            if (code.Contains("\0"))
            {
                ...
                if (isPalletCode)
                {
                    ...
                    if (isPalletCodeInCurrentTask)
                    {
                        ...
                        {
                            DAL.Entities.Pallet newPallet = new DAL.Entities.Pallet()
                            {
                                MarkingCode = code,
